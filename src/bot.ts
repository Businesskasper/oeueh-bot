...
export class Bot {
    ...
    public setup(): Promise<Bot> {
        ...
        this.client.on("interactionCreate", (interaction) => {
            interaction.inCachedGuild() &&
                this.messageBroker.dispatchInteractionReceived(interaction);
        });
    ...
    private isTextBasedChannel(
        ...
        return textChannelTypes.includes(channel.type as TextBasedChannelTypes);
    }

    private getChannel(channelId: string): Promise<AnyChannel | undefined> {
